...
module.exports = (sequelize, DataTypes) => {
  class ModelRating extends Model {
    ...
    static associate({ ModelPost, ModelServicePackage, BookingUser }) {
      // define association here
      this.belongsTo(ModelPost, {
        foreignKey: "ModelPostId",
      });
      this.belongsTo(ModelServicePackage, {
        foreignKey: "ModelServicePackageId",
      });
  ...
  ModelRating.init(
    {
      ...
      ModelServicePackageId: DataTypes.INTEGER,
      ModelBookingId: DataTypes.INTEGER,
