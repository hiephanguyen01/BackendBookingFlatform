...
module.exports = (sequelize, DataTypes) => {
  class ScheduleAndPriceClothesByDate extends Model {
    /**
  ...
  ScheduleAndPriceClothesByDate.init(
    {
    ...
    {
      sequelize,
      modelName: "ScheduleAndPriceClothesByDate",
    }
  );
  return ScheduleAndPriceClothesByDate;
};
