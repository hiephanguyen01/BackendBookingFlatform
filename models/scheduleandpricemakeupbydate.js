...
module.exports = (sequelize, DataTypes) => {
  class ScheduleAndPriceMakeUpByDate extends Model {
    /**
  ...
  ScheduleAndPriceMakeUpByDate.init(
    {
    ...
    {
      sequelize,
      modelName: "ScheduleAndPriceMakeUpByDate",
    }
  );
  return ScheduleAndPriceMakeUpByDate;
};
