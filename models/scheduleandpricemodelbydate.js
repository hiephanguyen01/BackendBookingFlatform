...
module.exports = (sequelize, DataTypes) => {
  class ScheduleAndPriceModelByDate extends Model {
    /**
  ...
  ScheduleAndPriceModelByDate.init(
    {
    ...
    {
      sequelize,
      modelName: "ScheduleAndPriceModelByDate",
    }
  );
  return ScheduleAndPriceModelByDate;
};
