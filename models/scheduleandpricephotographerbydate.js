...
module.exports = (sequelize, DataTypes) => {
  class ScheduleAndPricePhotographerByDate extends Model {
    /**
  ...
  ScheduleAndPricePhotographerByDate.init(
    {
    ...
    {
      sequelize,
      modelName: "ScheduleAndPricePhotographerByDate",
    }
  );
  return ScheduleAndPricePhotographerByDate;
};
